...
define KernelPackage/pptp
  ...
  KCONFIG:=CONFIG_PPTP
  FILES:= \
	$(LINUX_DIR)/drivers/net/pptp.$(LINUX_KMOD_SUFFIX)
endef

define KernelPackage/pptp/description
    Kernel modules for PPTP support
endef
...
define KernelPackage/ra-hwnat
  TITLE:=Ralink Hardware NAT for RT3052
  KCONFIG:=CONFIG_RA_HW_NAT
  DEPENDS:=@TARGET_keeneticCS||@TARGET_keenetic
  SUBMENU:=$(NETWORK_SUPPORT_MENU)
  FILES:=$(LINUX_DIR)/net/nat/hw_nat/hw_nat.$(LINUX_KMOD_SUFFIX)
endef

define KernelPackage/ra-hwnat/description
 Kernel modules Ralink Hardware NAT for RT3052
endef
$(eval $(call KernelPackage,ra-hwnat))
