...
define KernelPackage/net-rtl8180emb
  SUBMENU:=$(WIRELESS_MENU)
  TITLE:=RTL8180 wireless support
  DEPENDS:=@LINUX_2_4
  KCONFIG:=CONFIG_RTL8181_8180EMB
  FILES:=$(LINUX_DIR)/drivers/net/wireless/r8180emb/r8180.$(LINUX_KMOD_SUFFIX)
  AUTOLOAD:=$(call AutoLoad,60,rtl8180emb)
endef

define KernelPackage/net-rtl8180emb/description
 Kernel modules for RTL8180
endef

$(eval $(call KernelPackage,net-rtl8180emb))
